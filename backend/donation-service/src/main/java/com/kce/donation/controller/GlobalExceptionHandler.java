package com.kce.donation.controller;
...
public class GlobalExceptionHandler {
    ...
    // blood group, missing date/location - see DonationRequest). Without
    // this handler it falls through to the generic 500 below instead of
    // a proper 400 that tells the caller which field was wrong.
